@echo off
set MVN=C:\Program Files\NetBeans 8.0.2\java\maven\bin\mvn.bat
...
:rxtx
echo Adding rxtx-%JACOB_VERSION%.zip to repository ... 
call "%MVN%" install:install-file -Dfile="%RXTX_LIB_PATH%\rxtx-2.2-20081207.jar" -DgroupId=org.rxtx -DartifactId=rxtx -Dversion=2.2-20081207 -Dpackaging=jar -DlocalRepositoryPath="%REPOSITORY%"
...
call "%MVN%" install:install-file -Dfile="%RXTX_LIB_PATH%\x64\rxtxParallel.dll" -DgroupId=org.rxtx -DartifactId=rxtx -Dversion=2.2-20081207 -Dpackaging=dll -DlocalRepositoryPath="%REPOSITORY%" -Dclassifier=x64
call "%MVN%" install:install-file -Dfile="%RXTX_LIB_PATH%\x64\rxtxSerial.dll" -DgroupId=org.rxtx -DartifactId=rxtx -Dversion=2.2-20081207 -Dpackaging=dll -DlocalRepositoryPath="%REPOSITORY%" -Dclassifier=x64
call "%MVN%" install:install-file -Dfile="%RXTX_LIB_PATH%\x86\rxtxParallel.dll" -DgroupId=org.rxtx -DartifactId=rxtx -Dversion=2.2-20081207 -Dpackaging=dll -DlocalRepositoryPath="%REPOSITORY%" -Dclassifier=x86
call "%MVN%" install:install-file -Dfile="%RXTX_LIB_PATH%\x86\rxtxSerial.dll" -DgroupId=org.rxtx -DartifactId=rxtx -Dversion=2.2-20081207 -Dpackaging=dll -DlocalRepositoryPath="%REPOSITORY%" -Dclassifier=x86
...
echo rxtx - add rxtx-2.2-20081207 to local repository 
echo.
