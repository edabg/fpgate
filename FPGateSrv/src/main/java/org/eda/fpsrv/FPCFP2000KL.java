...
import org.datecs.fpcom.CS_BGR_FP2000_KL;

/**
 *
 * @author Dimitar Angelov
 */
public class FPCFP2000KL extends FPCBase {
    
    private CS_BGR_FP2000_KL FP;
    private int lastErrorCode;
    private String lastCommand;
    

    public FPCFP2000KL() throws Exception {
        super();
    }

    public static String getClassDecription() {
        return "This class supports Datecs FP 2000 KL fiscal printer!";
    }
    ...
    public static FPParams getDefinedParams() throws Exception {
        ...
        params.addGroups(
                new FPPropertyGroup("main", "Main Options") {{
                     ...
                     addProperty(new FPProperty(Integer.class, "LWIDTH", "Line width", "Line width in characters", 46));
                }}
    ...
    public void init() throws Exception, FPException {
        ...
        ComThread.InitMTA();
        this.FP = new CS_BGR_FP2000_KL();
        if (getParamInt("COM") > 0) { //By COM Port
            lastCommand = "iNIT_Ex1";
            FP.iNIT_Ex1(getParamInt("COM").byteValue(), getParamInt("BaudRate"));
        } else { // By IP Address
            lastCommand = "iNIT_EX2";
            FP.iNIT_EX2(getParam("IPAddr"), getParam("IPPort"));
        }
    }
