 ...
 */
public class FPCD55KL  extends FPCBase {

    private CS_BGR_DP55_KL FP;
    private int lastErrorCode;
    private String lastCommand;
    
    public FPCD55KL() throws Exception {
        super();
    }
