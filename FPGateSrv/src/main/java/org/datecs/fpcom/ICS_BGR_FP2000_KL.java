...
public class ICS_BGR_FP2000_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_FP2000_KL";

	public ICS_BGR_FP2000_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_FP2000_KL(Dispatch d) {
	...
	public ICS_BGR_FP2000_KL(String compName) {
		super(compName);
	}
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param iPAddr an input-parameter of type String
	 * @param subnetMask an input-parameter of type String
	 * @param tCPPort an input-parameter of type String
	 * @param defGateway an input-parameter of type String
	 * @param mACAddr an input-parameter of type String
	 * @return the result is of type int
	 */
	public int cMD_36_0_0(String iPAddr, String subnetMask, String tCPPort, String defGateway, String mACAddr) {
		return Dispatch.call(this, "CMD_36_0_0", iPAddr, subnetMask, tCPPort, defGateway, mACAddr).changeType(Variant.VariantInt).getInt();
	}

	/**
	 * Wrapper for calling the ActiveX-Method and receiving the output-parameter(s).
	 * @param iPAddr is an one-element array which sends the input-parameter
	 *               to the ActiveX-Component and receives the output-parameter
	 * @param subnetMask is an one-element array which sends the input-parameter
	 *                   to the ActiveX-Component and receives the output-parameter
	 * @param tCPPort is an one-element array which sends the input-parameter
	 *                to the ActiveX-Component and receives the output-parameter
	 * @param defGateway is an one-element array which sends the input-parameter
	 *                   to the ActiveX-Component and receives the output-parameter
	 * @param mACAddr is an one-element array which sends the input-parameter
	 *                to the ActiveX-Component and receives the output-parameter
	 * @return the result is of type int
	 */
	public int cMD_36_0_0(String[] iPAddr, String[] subnetMask, String[] tCPPort, String[] defGateway, String[] mACAddr) {
		Variant vnt_iPAddr = new Variant();
		if( iPAddr == null || iPAddr.length == 0 )
			vnt_iPAddr.putNoParam();
		else
			vnt_iPAddr.putStringRef(iPAddr[0]);

		Variant vnt_subnetMask = new Variant();
		if( subnetMask == null || subnetMask.length == 0 )
			vnt_subnetMask.putNoParam();
		else
			vnt_subnetMask.putStringRef(subnetMask[0]);

		Variant vnt_tCPPort = new Variant();
		if( tCPPort == null || tCPPort.length == 0 )
			vnt_tCPPort.putNoParam();
		else
			vnt_tCPPort.putStringRef(tCPPort[0]);

		Variant vnt_defGateway = new Variant();
		if( defGateway == null || defGateway.length == 0 )
			vnt_defGateway.putNoParam();
		else
			vnt_defGateway.putStringRef(defGateway[0]);

		Variant vnt_mACAddr = new Variant();
		if( mACAddr == null || mACAddr.length == 0 )
			vnt_mACAddr.putNoParam();
		else
			vnt_mACAddr.putStringRef(mACAddr[0]);

		int result_of_CMD_36_0_0 = Dispatch.call(this, "CMD_36_0_0", vnt_iPAddr, vnt_subnetMask, vnt_tCPPort, vnt_defGateway, vnt_mACAddr).changeType(Variant.VariantInt).getInt();

		if( iPAddr != null && iPAddr.length > 0 )
			iPAddr[0] = vnt_iPAddr.toString();
		if( subnetMask != null && subnetMask.length > 0 )
			subnetMask[0] = vnt_subnetMask.toString();
		if( tCPPort != null && tCPPort.length > 0 )
			tCPPort[0] = vnt_tCPPort.toString();
		if( defGateway != null && defGateway.length > 0 )
			defGateway[0] = vnt_defGateway.toString();
		if( mACAddr != null && mACAddr.length > 0 )
			mACAddr[0] = vnt_mACAddr.toString();

		return result_of_CMD_36_0_0;
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_36_0_1(String iPAddr, String subnetMask, String tCPPort, String defGateway, String mACAddr) {
		return Dispatch.call(this, "CMD_36_0_1", iPAddr, subnetMask, tCPPort, defGateway, mACAddr).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_36_0_2(String iPAddr, String subnetMask, String tCPPort, String defGateway) {
		return Dispatch.call(this, "CMD_36_0_2", iPAddr, subnetMask, tCPPort, defGateway).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_41_0_0(String switches) {
		return Dispatch.call(this, "CMD_41_0_0", switches).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_43_0_1(String iNP_STR, String dATA_VALUE) {
		return Dispatch.call(this, "CMD_43_0_1", iNP_STR, dATA_VALUE).changeType(Variant.VariantInt).getInt();
	}

	/**
	 * Wrapper for calling the ActiveX-Method and receiving the output-parameter(s).
	 * @param iNP_STR an input-parameter of type String
	 * @param dATA_VALUE is an one-element array which sends the input-parameter
	 *                   to the ActiveX-Component and receives the output-parameter
	 * @return the result is of type int
	 */
	public int cMD_43_0_1(String iNP_STR, String[] dATA_VALUE) {
		Variant vnt_dATA_VALUE = new Variant();
		if( dATA_VALUE == null || dATA_VALUE.length == 0 )
			vnt_dATA_VALUE.putNoParam();
		else
			vnt_dATA_VALUE.putStringRef(dATA_VALUE[0]);

		int result_of_CMD_43_0_1 = Dispatch.call(this, "CMD_43_0_1", iNP_STR, vnt_dATA_VALUE).changeType(Variant.VariantInt).getInt();

		if( dATA_VALUE != null && dATA_VALUE.length > 0 )
			dATA_VALUE[0] = vnt_dATA_VALUE.toString();
	 ...
	 * @return the result is of type int
	 */
	public int cMD_44_0_0(String tRGT_LINES) {
		return Dispatch.call(this, "CMD_44_0_0", tRGT_LINES).changeType(Variant.VariantInt).getInt();
	}
	...
	public int cMD_103_0_0(String[] canVd, String[] taxA, String[] taxB, String[] taxC, String[] taxD, String[] taxE, String[] taxF, String[] taxG, String[] taxH, String[] inv, String[] invNmb) {
		...
		int result_of_CMD_103_0_0 = Dispatch.callN(this, "CMD_103_0_0", new Object[] { vnt_canVd, vnt_taxA, vnt_taxB, vnt_taxC, vnt_taxD, vnt_taxE, vnt_taxF, vnt_taxG, vnt_taxH, vnt_inv, vnt_invNmb}).changeType(Variant.VariantInt).getInt();
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param iP_ADDRESS an input-parameter of type String
	 * @param pORT_NUMBER an input-parameter of type String
	 * @return the result is of type String
	 */
	public String iNIT_EX2(String iP_ADDRESS, String pORT_NUMBER) {
		return Dispatch.call(this, "INIT_EX2", iP_ADDRESS, pORT_NUMBER).toString();
	}
	 ...
	 * @param price an input-parameter of type String
	 * @param qwan an input-parameter of type String
	 * @param uN an input-parameter of type String
	 * @param perc an input-parameter of type String
	 * @return the result is of type int
	 */
	public int cMD_49_12_0(String l1, String l2, String taxCd, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_0", l1, l2, taxCd, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_1(String l1, String taxCd, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_1", l1, taxCd, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_2(String l2, String taxCd, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_2", l2, taxCd, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_3(String l1, String l2, String taxCd, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_3", l1, l2, taxCd, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_4(String l1, String taxCd, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_4", l1, taxCd, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_5(String l2, String taxCd, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_5", l2, taxCd, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_6(String l1, String l2, String taxCd, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_6", l1, l2, taxCd, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_7(String l1, String taxCd, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_7", l1, taxCd, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_8(String l2, String taxCd, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_8", l2, taxCd, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_9(String l1, String l2, String dept, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_9", l1, l2, dept, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_10(String l1, String dept, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_10", l1, dept, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_11(String l2, String dept, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_11", l2, dept, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_12(String l1, String l2, String dept, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_12", l1, l2, dept, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_13(String l1, String dept, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_13", l1, dept, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_14(String l2, String dept, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_14", l2, dept, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_15(String l1, String l2, String dept, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_15", l1, l2, dept, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_16(String l1, String dept, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_16", l1, dept, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_17(String l2, String dept, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_17", l2, dept, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_18(String taxCd, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_18", taxCd, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_19(String taxCd, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_19", taxCd, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_20(String taxCd, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_20", taxCd, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_21(String dept, String price, String qwan, String uN, String perc) {
		return Dispatch.call(this, "CMD_49_12_21", dept, price, qwan, uN, perc).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_22(String dept, String price, String qwan, String uN, String absSum) {
		return Dispatch.call(this, "CMD_49_12_22", dept, price, qwan, uN, absSum).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_49_12_23(String dept, String price, String qwan, String uN) {
		return Dispatch.call(this, "CMD_49_12_23", dept, price, qwan, uN).changeType(Variant.VariantInt).getInt();
	}
