...
public class ICS_BGR_WP500_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_WP500_KL";

	public ICS_BGR_WP500_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_WP500_KL(Dispatch d) {
	...
	public ICS_BGR_WP500_KL(String compName) {
		super(compName);
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_057(String tAXN, int errorCode) {
		return Dispatch.call(this, "command_057", tAXN, new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_057(String tAXN, int[] errorCode) {
		...
		int result_of_command_057 = Dispatch.call(this, "command_057", tAXN, vnt_errorCode).changeType(Variant.VariantInt).getInt();
	 ...
	 * @return the result is of type int
	 */
	public int command_064(int reportType, int errorCode, int nRep, String sumA, String sumB, String sumC, String sumD, String sumE, String sumF, String sumG, String sumH, String date) {
		return Dispatch.callN(this, "command_064", new Object[] { new Variant(reportType), new Variant(errorCode), new Variant(nRep), sumA, sumB, sumC, sumD, sumE, sumF, sumG, sumH, date}).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_064(int reportType, int[] errorCode, int[] nRep, String[] sumA, String[] sumB, String[] sumC, String[] sumD, String[] sumE, String[] sumF, String[] sumG, String[] sumH, String[] date) {
		...
		int result_of_command_064 = Dispatch.callN(this, "command_064", new Object[] { new Variant(reportType), vnt_errorCode, vnt_nRep, vnt_sumA, vnt_sumB, vnt_sumC, vnt_sumD, vnt_sumE, vnt_sumF, vnt_sumG, vnt_sumH, vnt_date}).changeType(Variant.VariantInt).getInt();
	 ...
	 * @return the result is of type int
	 */
	public int command_065(int reportType, int errorCode, int nRep, String sumA, String sumB, String sumC, String sumD, String sumE, String sumF, String sumG, String sumH) {
		return Dispatch.callN(this, "command_065", new Object[] { new Variant(reportType), new Variant(errorCode), new Variant(nRep), sumA, sumB, sumC, sumD, sumE, sumF, sumG, sumH}).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_065(int reportType, int[] errorCode, int[] nRep, String[] sumA, String[] sumB, String[] sumC, String[] sumD, String[] sumE, String[] sumF, String[] sumG, String[] sumH) {
		...
		int result_of_command_065 = Dispatch.callN(this, "command_065", new Object[] { new Variant(reportType), vnt_errorCode, vnt_nRep, vnt_sumA, vnt_sumB, vnt_sumC, vnt_sumD, vnt_sumE, vnt_sumF, vnt_sumG, vnt_sumH}).changeType(Variant.VariantInt).getInt();
	 ...
	 * @return the result is of type int
	 */
	public int command_070(int reportType, String amount, int errorCode, String cashSum, String cashIn, String cashOut) {
		return Dispatch.call(this, "command_070", new Variant(reportType), amount, new Variant(errorCode), cashSum, cashIn, cashOut).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_070(int reportType, String amount, int[] errorCode, String[] cashSum, String[] cashIn, String[] cashOut) {
		...
		int result_of_command_070 = Dispatch.call(this, "command_070", new Variant(reportType), amount, vnt_errorCode, vnt_cashSum, vnt_cashIn, vnt_cashOut).changeType(Variant.VariantInt).getInt();
	 ...
	 * @param tINnumber an input-parameter of type String
	 * @param errorCode an input-parameter of type int
	 * @return the result is of type int
	 */
	public int command_072(String serialNumber, String tINnumber, int errorCode) {
		return Dispatch.call(this, "command_072", serialNumber, tINnumber, new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_072(String serialNumber, String tINnumber, int[] errorCode) {
		...
		int result_of_command_072 = Dispatch.call(this, "command_072", serialNumber, tINnumber, vnt_errorCode).changeType(Variant.VariantInt).getInt();
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param startOperatorCode an input-parameter of type int
	 * @param endOperatorCode an input-parameter of type int
	 * @param clearType an input-parameter of type int
	 * @param errorCode an input-parameter of type int
	 * @return the result is of type int
	 */
	public int command_105(int startOperatorCode, int endOperatorCode, int clearType, int errorCode) {
		return Dispatch.call(this, "command_105", new Variant(startOperatorCode), new Variant(endOperatorCode), new Variant(clearType), new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_105(int startOperatorCode, int endOperatorCode, int clearType, int[] errorCode) {
		...
		int result_of_command_105 = Dispatch.call(this, "command_105", new Variant(startOperatorCode), new Variant(endOperatorCode), new Variant(clearType), vnt_errorCode).changeType(Variant.VariantInt).getInt();
	 ...
	 * @return the result is of type int
	 */
	public int command_106(int mSec, int errorCode) {
		return Dispatch.call(this, "command_106", new Variant(mSec), new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_106(int mSec, int[] errorCode) {
		...
		int result_of_command_106 = Dispatch.call(this, "command_106", new Variant(mSec), vnt_errorCode).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_106;
	}
	 ...
	 * @param total an input-parameter of type int
	 * @param prog an input-parameter of type int
	 * @param nameLen an input-parameter of type int
	 * @return the result is of type int
	 */
	public int command_140_v005(String option, int errorCode, int total, int prog, int nameLen) {
		return Dispatch.call(this, "command_140_v005", option, new Variant(errorCode), new Variant(total), new Variant(prog), new Variant(nameLen)).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @param prog is an one-element array which sends the input-parameter
	 *             to the ActiveX-Component and receives the output-parameter
	 * @param nameLen is an one-element array which sends the input-parameter
	 *                to the ActiveX-Component and receives the output-parameter
	 * @return the result is of type int
	 */
	public int command_140_v005(String option, int[] errorCode, int[] total, int[] prog, int[] nameLen) {
		...
		Variant vnt_nameLen = new Variant();
		if( nameLen == null || nameLen.length == 0 )
			vnt_nameLen.putNoParam();
		else
			vnt_nameLen.putIntRef(nameLen[0]);

		int result_of_command_140_v005 = Dispatch.call(this, "command_140_v005", option, vnt_errorCode, vnt_total, vnt_prog, vnt_nameLen).changeType(Variant.VariantInt).getInt();
		...
		if( prog != null && prog.length > 0 )
			prog[0] = vnt_prog.toInt();
		if( nameLen != null && nameLen.length > 0 )
			nameLen[0] = vnt_nameLen.toInt();

		return result_of_command_140_v005;
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param option an input-parameter of type String
	 * @param fIRM an input-parameter of type int
	 * @param name an input-parameter of type String
	 * @param tAXN an input-parameter of type String
	 * @param typeTAXN an input-parameter of type int
	 * @param recName an input-parameter of type String
	 * @param vATN an input-parameter of type String
	 * @param addr1 an input-parameter of type String
	 * @param addr2 an input-parameter of type String
	 * @param errorCode an input-parameter of type int
	 * @return the result is of type int
	 */
	public int command_140_v006(String option, int fIRM, String name, String tAXN, int typeTAXN, String recName, String vATN, String addr1, String addr2, int errorCode) {
		return Dispatch.callN(this, "command_140_v006", new Object[] { option, new Variant(fIRM), name, tAXN, new Variant(typeTAXN), recName, vATN, addr1, addr2, new Variant(errorCode)}).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_140_v006(String option, int fIRM, String name, String tAXN, int typeTAXN, String recName, String vATN, String addr1, String addr2, int[] errorCode) {
		...
		int result_of_command_140_v006 = Dispatch.callN(this, "command_140_v006", new Object[] { option, new Variant(fIRM), name, tAXN, new Variant(typeTAXN), recName, vATN, addr1, addr2, vnt_errorCode}).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_140_v006;
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param option an input-parameter of type String
	 * @param firstFIRM an input-parameter of type int
	 * @param lastFIRM an input-parameter of type int
	 * @param errorCode an input-parameter of type int
	 * @return the result is of type int
	 */
	public int command_140_v007(String option, int firstFIRM, int lastFIRM, int errorCode) {
		return Dispatch.call(this, "command_140_v007", option, new Variant(firstFIRM), new Variant(lastFIRM), new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_140_v007(String option, int firstFIRM, int lastFIRM, int[] errorCode) {
		...
		int result_of_command_140_v007 = Dispatch.call(this, "command_140_v007", option, new Variant(firstFIRM), new Variant(lastFIRM), vnt_errorCode).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_140_v007;
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param option an input-parameter of type String
	 * @param in_FIRM an input-parameter of type int
	 * @param errorCode an input-parameter of type int
	 * @param out_FIRM an input-parameter of type int
	 * @param name an input-parameter of type String
	 * @param tAXN an input-parameter of type String
	 * @param typeTAXN an input-parameter of type int
	 * @param recName an input-parameter of type String
	 ...
	 * @return the result is of type int
	 */
	public int command_140_v008(String option, int in_FIRM, int errorCode, int out_FIRM, String name, String tAXN, int typeTAXN, String recName, String vATN, String addr1, String addr2) {
		return Dispatch.callN(this, "command_140_v008", new Object[] { option, new Variant(in_FIRM), new Variant(errorCode), new Variant(out_FIRM), name, tAXN, new Variant(typeTAXN), recName, vATN, addr1, addr2}).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @param errorCode is an one-element array which sends the input-parameter
	 *                  to the ActiveX-Component and receives the output-parameter
	 * @param out_FIRM is an one-element array which sends the input-parameter
	 *                 to the ActiveX-Component and receives the output-parameter
	 * @param name is an one-element array which sends the input-parameter
	 *             to the ActiveX-Component and receives the output-parameter
	 * @param tAXN is an one-element array which sends the input-parameter
	 *             to the ActiveX-Component and receives the output-parameter
	 * @param typeTAXN is an one-element array which sends the input-parameter
	 *                 to the ActiveX-Component and receives the output-parameter
	 * @param recName is an one-element array which sends the input-parameter
	 *                to the ActiveX-Component and receives the output-parameter
	 * @param vATN is an one-element array which sends the input-parameter
	 *             to the ActiveX-Component and receives the output-parameter
	 * @param addr1 is an one-element array which sends the input-parameter
	 *              to the ActiveX-Component and receives the output-parameter
	 * @param addr2 is an one-element array which sends the input-parameter
	 *              to the ActiveX-Component and receives the output-parameter
	 * @return the result is of type int
	 */
	public int command_140_v008(String option, int in_FIRM, int[] errorCode, int[] out_FIRM, String[] name, String[] tAXN, int[] typeTAXN, String[] recName, String[] vATN, String[] addr1, String[] addr2) {
		...
		Variant vnt_out_FIRM = new Variant();
		if( out_FIRM == null || out_FIRM.length == 0 )
			vnt_out_FIRM.putNoParam();
		else
			vnt_out_FIRM.putIntRef(out_FIRM[0]);
		...
		Variant vnt_tAXN = new Variant();
		if( tAXN == null || tAXN.length == 0 )
			vnt_tAXN.putNoParam();
		else
			vnt_tAXN.putStringRef(tAXN[0]);

		Variant vnt_typeTAXN = new Variant();
		if( typeTAXN == null || typeTAXN.length == 0 )
			vnt_typeTAXN.putNoParam();
		else
			vnt_typeTAXN.putIntRef(typeTAXN[0]);

		Variant vnt_recName = new Variant();
		if( recName == null || recName.length == 0 )
			vnt_recName.putNoParam();
		else
			vnt_recName.putStringRef(recName[0]);

		Variant vnt_vATN = new Variant();
		if( vATN == null || vATN.length == 0 )
			vnt_vATN.putNoParam();
		else
			vnt_vATN.putStringRef(vATN[0]);

		Variant vnt_addr1 = new Variant();
		if( addr1 == null || addr1.length == 0 )
			vnt_addr1.putNoParam();
		else
			vnt_addr1.putStringRef(addr1[0]);

		Variant vnt_addr2 = new Variant();
		if( addr2 == null || addr2.length == 0 )
			vnt_addr2.putNoParam();
		else
			vnt_addr2.putStringRef(addr2[0]);

		int result_of_command_140_v008 = Dispatch.callN(this, "command_140_v008", new Object[] { option, new Variant(in_FIRM), vnt_errorCode, vnt_out_FIRM, vnt_name, vnt_tAXN, vnt_typeTAXN, vnt_recName, vnt_vATN, vnt_addr1, vnt_addr2}).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();
		if( out_FIRM != null && out_FIRM.length > 0 )
			out_FIRM[0] = vnt_out_FIRM.toInt();
		if( name != null && name.length > 0 )
			name[0] = vnt_name.toString();
		if( tAXN != null && tAXN.length > 0 )
			tAXN[0] = vnt_tAXN.toString();
		if( typeTAXN != null && typeTAXN.length > 0 )
			typeTAXN[0] = vnt_typeTAXN.toInt();
		if( recName != null && recName.length > 0 )
			recName[0] = vnt_recName.toString();
		if( vATN != null && vATN.length > 0 )
			vATN[0] = vnt_vATN.toString();
		if( addr1 != null && addr1.length > 0 )
			addr1[0] = vnt_addr1.toString();
		if( addr2 != null && addr2.length > 0 )
			addr2[0] = vnt_addr2.toString();

		return result_of_command_140_v008;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_140_v009(String option, int in_FIRM, int errorCode, int out_FIRM, String name, String tAXN, int typeTAXN, String recName, String vATN, String addr1, String addr2) {
		return Dispatch.callN(this, "command_140_v009", new Object[] { option, new Variant(in_FIRM), new Variant(errorCode), new Variant(out_FIRM), name, tAXN, new Variant(typeTAXN), recName, vATN, addr1, addr2}).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_140_v009(String option, int in_FIRM, int[] errorCode, int[] out_FIRM, String[] name, String[] tAXN, int[] typeTAXN, String[] recName, String[] vATN, String[] addr1, String[] addr2) {
		...
		int result_of_command_140_v009 = Dispatch.callN(this, "command_140_v009", new Object[] { option, new Variant(in_FIRM), vnt_errorCode, vnt_out_FIRM, vnt_name, vnt_tAXN, vnt_typeTAXN, vnt_recName, vnt_vATN, vnt_addr1, vnt_addr2}).changeType(Variant.VariantInt).getInt();
		...
		return result_of_command_140_v009;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_140_v010(String option, int in_FIRM, int errorCode, int out_FIRM, String name, String tAXN, int typeTAXN, String recName, String vATN, String addr1, String addr2) {
		return Dispatch.callN(this, "command_140_v010", new Object[] { option, new Variant(in_FIRM), new Variant(errorCode), new Variant(out_FIRM), name, tAXN, new Variant(typeTAXN), recName, vATN, addr1, addr2}).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_140_v010(String option, int in_FIRM, int[] errorCode, int[] out_FIRM, String[] name, String[] tAXN, int[] typeTAXN, String[] recName, String[] vATN, String[] addr1, String[] addr2) {
		...
		int result_of_command_140_v010 = Dispatch.callN(this, "command_140_v010", new Object[] { option, new Variant(in_FIRM), vnt_errorCode, vnt_out_FIRM, vnt_name, vnt_tAXN, vnt_typeTAXN, vnt_recName, vnt_vATN, vnt_addr1, vnt_addr2}).changeType(Variant.VariantInt).getInt();
		...
		return result_of_command_140_v010;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_140_v011(String option, int errorCode, int fIRM, String name, String tAXN, int typeTAXN, String recName, String vATN, String addr1, String addr2) {
		return Dispatch.callN(this, "command_140_v011", new Object[] { option, new Variant(errorCode), new Variant(fIRM), name, tAXN, new Variant(typeTAXN), recName, vATN, addr1, addr2}).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @param errorCode is an one-element array which sends the input-parameter
	 *                  to the ActiveX-Component and receives the output-parameter
	 * @param fIRM is an one-element array which sends the input-parameter
	 *             to the ActiveX-Component and receives the output-parameter
	 * @param name is an one-element array which sends the input-parameter
	 *             to the ActiveX-Component and receives the output-parameter
	 * @param tAXN is an one-element array which sends the input-parameter
	...
	public int command_140_v011(String option, int[] errorCode, int[] fIRM, String[] name, String[] tAXN, int[] typeTAXN, String[] recName, String[] vATN, String[] addr1, String[] addr2) {
		...
		Variant vnt_fIRM = new Variant();
		if( fIRM == null || fIRM.length == 0 )
			vnt_fIRM.putNoParam();
		else
			vnt_fIRM.putIntRef(fIRM[0]);
		...
		int result_of_command_140_v011 = Dispatch.callN(this, "command_140_v011", new Object[] { option, vnt_errorCode, vnt_fIRM, vnt_name, vnt_tAXN, vnt_typeTAXN, vnt_recName, vnt_vATN, vnt_addr1, vnt_addr2}).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();
		if( fIRM != null && fIRM.length > 0 )
			fIRM[0] = vnt_fIRM.toInt();
		if( name != null && name.length > 0 )
			name[0] = vnt_name.toString();
		if( tAXN != null && tAXN.length > 0 )
			tAXN[0] = vnt_tAXN.toString();
		...
		return result_of_command_140_v011;
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param option an input-parameter of type String
	 * @param in_TAXN an input-parameter of type String
	 * @param errorCode an input-parameter of type int
	 * @param fIRM an input-parameter of type int
	 * @param name an input-parameter of type String
	 * @param out_TAXN an input-parameter of type String
	 * @param typeTAXN an input-parameter of type int
	 * @param recName an input-parameter of type String
	 * @param vATN an input-parameter of type String
	 * @param addr1 an input-parameter of type String
	 ...
	 * @return the result is of type int
	 */
	public int command_140_v012(String option, String in_TAXN, int errorCode, int fIRM, String name, String out_TAXN, int typeTAXN, String recName, String vATN, String addr1, String addr2) {
		return Dispatch.callN(this, "command_140_v012", new Object[] { option, in_TAXN, new Variant(errorCode), new Variant(fIRM), name, out_TAXN, new Variant(typeTAXN), recName, vATN, addr1, addr2}).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @param name is an one-element array which sends the input-parameter
	 *             to the ActiveX-Component and receives the output-parameter
	 * @param out_TAXN is an one-element array which sends the input-parameter
	 *                 to the ActiveX-Component and receives the output-parameter
	 * @param typeTAXN is an one-element array which sends the input-parameter
	 *                 to the ActiveX-Component and receives the output-parameter
	 * @param recName is an one-element array which sends the input-parameter
	...
	public int command_140_v012(String option, String in_TAXN, int[] errorCode, int[] fIRM, String[] name, String[] out_TAXN, int[] typeTAXN, String[] recName, String[] vATN, String[] addr1, String[] addr2) {
		...
		Variant vnt_out_TAXN = new Variant();
		if( out_TAXN == null || out_TAXN.length == 0 )
			vnt_out_TAXN.putNoParam();
		else
			vnt_out_TAXN.putStringRef(out_TAXN[0]);
		...
		int result_of_command_140_v012 = Dispatch.callN(this, "command_140_v012", new Object[] { option, in_TAXN, vnt_errorCode, vnt_fIRM, vnt_name, vnt_out_TAXN, vnt_typeTAXN, vnt_recName, vnt_vATN, vnt_addr1, vnt_addr2}).changeType(Variant.VariantInt).getInt();
		...
		if( name != null && name.length > 0 )
			name[0] = vnt_name.toString();
		if( out_TAXN != null && out_TAXN.length > 0 )
			out_TAXN[0] = vnt_out_TAXN.toString();
		if( typeTAXN != null && typeTAXN.length > 0 )
			typeTAXN[0] = vnt_typeTAXN.toInt();
		if( recName != null && recName.length > 0 )
			recName[0] = vnt_recName.toString();
		...
		return result_of_command_140_v012;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_140_v013(String option, int in_FIRM, int errorCode, int out_FIRM) {
		return Dispatch.call(this, "command_140_v013", option, new Variant(in_FIRM), new Variant(errorCode), new Variant(out_FIRM)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_140_v013(String option, int in_FIRM, int[] errorCode, int[] out_FIRM) {
		...
		int result_of_command_140_v013 = Dispatch.call(this, "command_140_v013", option, new Variant(in_FIRM), vnt_errorCode, vnt_out_FIRM).changeType(Variant.VariantInt).getInt();
		...
		return result_of_command_140_v013;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_140_v014(String option, int in_FIRM, int errorCode, int out_FIRM) {
		return Dispatch.call(this, "command_140_v014", option, new Variant(in_FIRM), new Variant(errorCode), new Variant(out_FIRM)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_140_v014(String option, int in_FIRM, int[] errorCode, int[] out_FIRM) {
		...
		int result_of_command_140_v014 = Dispatch.call(this, "command_140_v014", option, new Variant(in_FIRM), vnt_errorCode, vnt_out_FIRM).changeType(Variant.VariantInt).getInt();
		...
		return result_of_command_140_v014;
	}
