...
public class ICS_BGR_SK1_31F_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_SK1_31F_KL";

	public ICS_BGR_SK1_31F_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_SK1_31F_KL(Dispatch d) {
	...
	public ICS_BGR_SK1_31F_KL(String compName) {
		super(compName);
	}
	 ...
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param iTEM_INDEX an input-parameter of type String
	 * @param oUT_STR an input-parameter of type String
	 * @return the result is of type int
	 */
	public int cMD_43_0_1(String iTEM_INDEX, String oUT_STR) {
		return Dispatch.call(this, "CMD_43_0_1", iTEM_INDEX, oUT_STR).changeType(Variant.VariantInt).getInt();
	}

	/**
	 * Wrapper for calling the ActiveX-Method and receiving the output-parameter(s).
	 * @param iTEM_INDEX an input-parameter of type String
	 * @param oUT_STR is an one-element array which sends the input-parameter
	 *                to the ActiveX-Component and receives the output-parameter
	 * @return the result is of type int
	 */
	public int cMD_43_0_1(String iTEM_INDEX, String[] oUT_STR) {
		Variant vnt_oUT_STR = new Variant();
		if( oUT_STR == null || oUT_STR.length == 0 )
			vnt_oUT_STR.putNoParam();
		else
			vnt_oUT_STR.putStringRef(oUT_STR[0]);

		int result_of_CMD_43_0_1 = Dispatch.call(this, "CMD_43_0_1", iTEM_INDEX, vnt_oUT_STR).changeType(Variant.VariantInt).getInt();

		if( oUT_STR != null && oUT_STR.length > 0 )
			oUT_STR[0] = vnt_oUT_STR.toString();
	...
	public int getdefaultTimeOut() {
		return Dispatch.get(this, "defaultTimeOut").changeType(Variant.VariantInt).getInt();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param defaultTimeOut an input-parameter of type int
	 */
	public void setdefaultTimeOut(int defaultTimeOut) {
		Dispatch.put(this, "defaultTimeOut", defaultTimeOut);
	}
	...
	public int getrepeatCount() {
		return Dispatch.get(this, "repeatCount").changeType(Variant.VariantInt).getInt();
	}
	...
	public void setrepeatCount(int repeatCount) {
		Dispatch.put(this, "repeatCount", new Variant(repeatCount));
	}
	...
	public short getcodePage() {
		return Dispatch.get(this, "codePage").changeType(Variant.VariantShort).getShort();
	}
	...
	public boolean getdebugMode() {
		return Dispatch.get(this, "debugMode").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param debugMode an input-parameter of type boolean
	 */
	public void setdebugMode(boolean debugMode) {
		Dispatch.put(this, "debugMode", new Variant(debugMode));
	}
	...
	public String getdebugFolder() {
		return Dispatch.get(this, "debugFolder").toString();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param debugFolder an input-parameter of type String
	 */
	public void setdebugFolder(String debugFolder) {
		Dispatch.put(this, "debugFolder", debugFolder);
	}
