...
public class ICS_BGR_FP1000_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_FP1000_KL";

	public ICS_BGR_FP1000_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_FP1000_KL(Dispatch d) {
	...
	public ICS_BGR_FP1000_KL(String compName) {
		super(compName);
	}
