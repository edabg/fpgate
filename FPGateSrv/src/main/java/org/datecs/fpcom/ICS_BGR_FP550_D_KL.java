...
public class ICS_BGR_FP550_D_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_FP550_D_KL";

	public ICS_BGR_FP550_D_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_FP550_D_KL(Dispatch d) {
	...
	public ICS_BGR_FP550_D_KL(String compName) {
		super(compName);
	}
