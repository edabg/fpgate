...
public class ICS_BGR_FP705_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_FP705_KL";

	public ICS_BGR_FP705_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_FP705_KL(Dispatch d) {
	...
	public ICS_BGR_FP705_KL(String compName) {
		super(compName);
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_033(int errorCode) {
		return Dispatch.call(this, "command_033", new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_033(int[] errorCode) {
		...
		int result_of_command_033 = Dispatch.call(this, "command_033", vnt_errorCode).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_033;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_035(String in_Text, int errorCode) {
		return Dispatch.call(this, "command_035", in_Text, new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_035(String in_Text, int[] errorCode) {
		...
		int result_of_command_035 = Dispatch.call(this, "command_035", in_Text, vnt_errorCode).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_035;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_046(int errorCode) {
		return Dispatch.call(this, "command_046", new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_046(int[] errorCode) {
		...
		int result_of_command_046 = Dispatch.call(this, "command_046", vnt_errorCode).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_046;
	}
	 ...
	 * @return the result is of type int
	 */
	public int command_047(String in_Text, int errorCode) {
		return Dispatch.call(this, "command_047", in_Text, new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_047(String in_Text, int[] errorCode) {
		...
		int result_of_command_047 = Dispatch.call(this, "command_047", in_Text, vnt_errorCode).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_047;
	}
	 ...
	 * @param display an input-parameter of type int
	 * @param discountType an input-parameter of type int
	 * @param discountValue an input-parameter of type String
	 * @param errorCode an input-parameter of type int
	 * @param slipNumber an input-parameter of type int
	 ...
	 * @return the result is of type int
	 */
	public int command_051(int print, int display, int discountType, String discountValue, int errorCode, int slipNumber, String subTotal, String taxA, String taxB, String taxC, String taxD, String taxE, String taxF, String taxG, String taxH) {
		return Dispatch.callN(this, "command_051", new Object[] { new Variant(print), new Variant(display), new Variant(discountType), discountValue, new Variant(errorCode), new Variant(slipNumber), subTotal, taxA, taxB, taxC, taxD, taxE, taxF, taxG, taxH}).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_051(int print, int display, int discountType, String discountValue, int[] errorCode, int[] slipNumber, String[] subTotal, String[] taxA, String[] taxB, String[] taxC, String[] taxD, String[] taxE, String[] taxF, String[] taxG, String[] taxH) {
		...
		int result_of_command_051 = Dispatch.callN(this, "command_051", new Object[] { new Variant(print), new Variant(display), new Variant(discountType), discountValue, vnt_errorCode, vnt_slipNumber, vnt_subTotal, vnt_taxA, vnt_taxB, vnt_taxC, vnt_taxD, vnt_taxE, vnt_taxF, vnt_taxG, vnt_taxH}).changeType(Variant.VariantInt).getInt();
	 ...
	 * @return the result is of type int
	 */
	public int command_084(int in_Type, String data, int errorCode) {
		return Dispatch.call(this, "command_084", new Variant(in_Type), data, new Variant(errorCode)).changeType(Variant.VariantInt).getInt();
	}
	...
	public int command_084(int in_Type, String data, int[] errorCode) {
		...
		int result_of_command_084 = Dispatch.call(this, "command_084", new Variant(in_Type), data, vnt_errorCode).changeType(Variant.VariantInt).getInt();

		if( errorCode != null && errorCode.length > 0 )
			errorCode[0] = vnt_errorCode.toInt();

		return result_of_command_084;
	}
