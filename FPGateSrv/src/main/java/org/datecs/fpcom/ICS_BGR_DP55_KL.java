...
public class ICS_BGR_DP55_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_DP55_KL";

	public ICS_BGR_DP55_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_DP55_KL(Dispatch d) {
	...
	public ICS_BGR_DP55_KL(String compName) {
		super(compName);
	}
	...
	/**
	 * Wrapper for calling the ActiveX-Method and receiving the output-parameter(s).
	 * @param theText is an one-element array which sends the input-parameter
	 *                to the ActiveX-Component and receives the output-parameter
	 * @return the result is of type int
	 */
	public int cMD_42_0_0(String[] theText) {
		Variant vnt_theText = new Variant();
		if( theText == null || theText.length == 0 )
			vnt_theText.putNoParam();
		else
			vnt_theText.putStringRef(theText[0]);

		int result_of_CMD_42_0_0 = Dispatch.call(this, "CMD_42_0_0", vnt_theText).changeType(Variant.VariantInt).getInt();

		if( theText != null && theText.length > 0 )
			theText[0] = vnt_theText.toString();

		return result_of_CMD_42_0_0;
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_57_0_0(String bulstat, String seller, String receiver, String clientName, String taxNo, String address1) {
		return Dispatch.call(this, "CMD_57_0_0", bulstat, seller, receiver, clientName, taxNo, address1).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 * @return the result is of type int
	 */
	public int cMD_65_0_0(String option, String totA, String totB, String totC, String totD, String totE, String totF, String totG, String totH) {
		return Dispatch.callN(this, "CMD_65_0_0", new Object[] { option, totA, totB, totC, totD, totE, totF, totG, totH}).changeType(Variant.VariantInt).getInt();
	}
	...
	public int cMD_65_0_0(String option, String[] totA, String[] totB, String[] totC, String[] totD, String[] totE, String[] totF, String[] totG, String[] totH) {
		...
		int result_of_CMD_65_0_0 = Dispatch.callN(this, "CMD_65_0_0", new Object[] { option, vnt_totA, vnt_totB, vnt_totC, vnt_totD, vnt_totE, vnt_totF, vnt_totG, vnt_totH}).changeType(Variant.VariantInt).getInt();
	...
	public int cMD_88_0_0(String dept, String exitCode, String[] taxGr, String[] recSales, String[] recSum, String[] totSales, String[] totSum, String[] line1, String[] line2) {
		...
		int result_of_CMD_88_0_0 = Dispatch.callN(this, "CMD_88_0_0", new Object[] { dept, exitCode, vnt_taxGr, vnt_recSales, vnt_recSum, vnt_totSales, vnt_totSum, vnt_line1, vnt_line2}).changeType(Variant.VariantInt).getInt();
	 ...
	 * @param ser an input-parameter of type String
	 * @param fM an input-parameter of type String
	 * @return the result is of type int
	 */
	public int cMD_90_0_0(String printerName, String fwRev, String fwDate, String fwTime, String chk, String sw, String ser, String fM) {
		return Dispatch.call(this, "CMD_90_0_0", printerName, fwRev, fwDate, fwTime, chk, sw, ser, fM).changeType(Variant.VariantInt).getInt();
	}
	 ...
	 *           to the ActiveX-Component and receives the output-parameter
	 * @param ser is an one-element array which sends the input-parameter
	 *            to the ActiveX-Component and receives the output-parameter
	...
	public int cMD_90_0_0(String[] printerName, String[] fwRev, String[] fwDate, String[] fwTime, String[] chk, String[] sw, String[] ser, String[] fM) {
		...
		Variant vnt_ser = new Variant();
		if( ser == null || ser.length == 0 )
			vnt_ser.putNoParam();
		else
			vnt_ser.putStringRef(ser[0]);
		...
		int result_of_CMD_90_0_0 = Dispatch.call(this, "CMD_90_0_0", vnt_printerName, vnt_fwRev, vnt_fwDate, vnt_fwTime, vnt_chk, vnt_sw, vnt_ser, vnt_fM).changeType(Variant.VariantInt).getInt();
