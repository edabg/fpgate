...
public class ICS_BGR_FP700_KL extends Dispatch {

	public static final String componentName = "FP3530.ICS_BGR_FP700_KL";

	public ICS_BGR_FP700_KL() {
		super(componentName);
	}
	...
	*/
	public ICS_BGR_FP700_KL(Dispatch d) {
	...
	public ICS_BGR_FP700_KL(String compName) {
		super(compName);
	}
